...
<body>
  ...
  <div class="container-fluid container">
	...
	<div class="container">
		...
		<tbody>
			<c:forEach var="librarylog" items="${list}">
				<tr>
					<td>${librarylog.libraryName}</td>
					<td>${librarylog.cityName}</td>
					<td>${librarylog.libraryType}</td>
					<td>${librarylog.homepage}</td>
					<td>${librarylog.changedate}</td>
					<td>${librarylog.action}</td>

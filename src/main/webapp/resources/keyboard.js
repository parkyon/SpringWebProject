/* ********************************************************************
 **********************************************************************
 * HTML Virtual Keyboard Interface Script - v1.41
...
var VKI_attach, VKI_close;
  function VKI_buildKeyboardInputs() {
    ...
    this.VKI_kts = this.VKI_kt = "Korean";  // Default keyboard layout
    this.VKI_langAdapt = true;  // Use lang attribute of input to select keyboard
    this.VKI_size = 2;  // Default keyboard size (1-5)
    this.VKI_sizeAdj = true;  // Allow user to adjust keyboard size
    this.VKI_clearPasswords = false;  // Clear password fields on focus
    this.VKI_imageURI = "/resources/jpg/keyboard.png";  // If empty string, use imageless mode
    ...
    this.VKI_layout.Korean = [ // KR ---블루비추가--
      ...
      [[" ", " "]]
    ]; this.VKI_layout.Korean.lang = ["한글"];
    ...
    this.VKI_layout.Assamese = [ // Assamese Keyboard
      ...
      [[" ", " ", " ", " "], ["AltGr", "AltGr"]]
    ]; this.VKI_layout.Assamese.lang = ["as"];
    ...
    this.VKI_layout.Bosnian = [ // Bosnian, Croatian, Serbian (Latin) and Slovene Standard Keyboard
      ...
      [[" ", " ", " ", " "], ["AltGr", "AltGr"]]
    ]; this.VKI_layout.Bosnian.lang = ["sh"];
    ...
    this.VKI_layout['Bulgarian BDS'] = [ // Bulgarian BDS Keyboard
    ...
    this.VKI_layout.Croatian = this.VKI_layout.Bosnian.slice(0);
    this.VKI_layout.Croatian.lang = ["hr"];
    ...
    this.VKI_layout.Dari = [ // Dari Keyboard
    ...
    this.VKI_layout.Khmer = [ // Khmer Standard Keyboard
      ...
      [["\u200B", " ", "\u00A0", " "], ["AltGr", "AltGr"]]
    ]; this.VKI_layout.Khmer.lang = ["km"];

    this.VKI_layout.Kurdish = [ // Kurdish Keyboard
      ...
      [[" ", " "]]
    ]; this.VKI_layout.Kurdish.lang = ["ku"];
    ...
    this.VKI_layout.SerbianLat = this.VKI_layout.Bosnian.slice(0);
    ...
    this.VKI_layout.Slovenian = this.VKI_layout.Bosnian.slice(0);
              ...
              for (var y = 0, lkey; lkey = lyt[y++];) {
                var td = document.createElement('td');
                  ...
                  switch (lkey[1]) {
                    ...
                    default:
                      td.onclick = function() {
                        var rezzed = false, character = "\xa0";
                          ...
                          if (self.VKI_dead != character) {
                            for (key in self.VKI_deadkey) {
                              if (key == self.VKI_dead) {
                                if (character != " ") {
                                  for (var z = 0, dk; dk = self.VKI_deadkey[key][z++];) {
                                    if (dk[0] == character) {
    ...
    this.VKI_modify = function(type) {
      ...
      for (var x = 0; x < tables.length; x++) {
        ...
        for (var y = 0; y < tds.length; y++) {
          ...
          if (this.VKI_isOpera) {
            tds[y].style.width = "50px";
            var foo = tds[y].offsetWidth;
            tds[y].style.width = "";
          }
        }
      }
